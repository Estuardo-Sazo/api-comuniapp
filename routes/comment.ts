...
//? UPDATE POST DATE
commentRoutes.post('/update-date', [verificaToken],[verificaTokenPermis], (req: any, res: Response) => {
    ...
    if(req.typeUser=='USER'){
        ...
        Comment.findByIdAndUpdate(body._id, body, { new: true, runValidators: true}, (err: any, dataDB: any) => {   
